        ...
        <div className="min-h-screen flex items-center justify-center px-5 py-5">
            <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden"
                ...
                <div className="md:flex w-full">
                    ...
                    <form onSubmit={login} className="w-full md:w-1/2 py-10 px-5 md:px-10">
                        ...
                        <div>
                            ...
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5">
                                    <button
                                        className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">LOGIN NOW
                                    </button>
                                    <Link to="/register">
                                        <p className="mt-2 text-center text-gray-600">Register</p>
                                    </Link>
                                    <Link to="/forgotpassword">
                                        <p className="mt-2 text-center text-gray-600">Forgot your password?</p>
                                    </Link>
                                </div>
                            </div>
                        </div>
