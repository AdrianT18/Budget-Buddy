...
export default function Register() {
    ...
    const signUp = (e) => {
        ...
        else if (firstname === '' || lastname === '' || username === '' || email === '' || password === '' || repeat === '') {
                ...
                <div className="md:flex w-full">
                    <div className="hidden md:block w-1/2 bg-indigo-500 py-10 px-10">
                        <svg id="a87032b8-5b37-4b7e-a4d9-4dbfbe394641" data-name="Layer 1"
                             xmlns="http://www.w3.org/2000/svg" width="100%"  className="h-auto"
                        ...
                        <div>
                            <div className="flex -mx-3">
                                <div className="w-1/2 px-3 mb-5">
                                    ...
                                    <div className="flex">
                                        <div
                                            ...
                                            <i className="mdi mdi-account-outline text-gray-400 text-lg"/></div>
                                        <input type="text"
                                               className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                               placeholder="John" required onChange={(e) =>
                                ...
                                <div className="w-1/2 px-3 mb-5">
                                    ...
                                    <div className="flex">
                                        ...
                                        <input type="text"
                                               className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                               placeholder="Smith" required onChange={(e) =>
                            ...
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5">
                                    ...
                                    <div className="flex">
                                        ...
                                        <input type="text"
                                               className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                               placeholder="Johnny Sins" required onChange={(e) =>
                            ...
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5">
                                    ...
                                    <div className="flex">
                                        <div
                                            className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                            <i className="mdi mdi-email-outline text-gray-400 text-lg"/></div>
                                        <input type="email"
                                               className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                               placeholder="johnsmith@example.com" required value={email}
                            ...
                            <div className="flex flex-col -mx-3">
                                <div className="w-full px-3 mb-5">
                                    ...
                                    <div className="flex">
                                        <div
                                            className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                            <i className="mdi mdi-lock-outline text-gray-400 text-lg"/></div>
                                        <input type="password"
                                               className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                            ...
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5">
                                    ...
                                    <Link to="/login">
                                        <p className="mt-2 text-center text-gray-600">Already have an account?</p>
                                    </Link>
                                </div>
                            </div>
                        </div>
